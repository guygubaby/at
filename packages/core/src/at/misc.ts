 ...
 *
 * For more information, see: https://daneden.github.io/animate.css/
 */
export const AnimateCssPresets: Record<AnimateCssNames, AnimateCssNames> = {
  bounce: 'bounce',
  flash: 'flash',
  pulse: 'pulse',
...
export const DEFAULT_DIRATION = 1 * 1000
